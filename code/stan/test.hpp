...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in '/Users/gchure/Dropbox/git/postdoc_projects/growth_curve_troubleshooting/code/stan/test.stan', line 2, column 2 to column 9)",
                                                      " (in '/Users/gchure/Dropbox/git/postdoc_projects/growth_curve_troubleshooting/code/stan/test.stan', line 7, column 2 to column 19)"};
...
class test_model final : public model_base_crtp<test_model> {
 ...
 public:
  ...
  std::string model_name() const final { return "test_model"; }
